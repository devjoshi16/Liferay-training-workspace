...
public class Branch implements Serializable {
	...
	public static Branch toDTO(String json) {
		return ObjectMapperUtil.readValue(Branch.class, json);
	}

	public static Branch unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Branch.class, json);
	}
	...
	public void setAddr1(
		UnsafeSupplier<String, Exception> addr1UnsafeSupplier) {

		try {
			addr1 = addr1UnsafeSupplier.get();
		}
	...
	public void setAddr2(
		UnsafeSupplier<String, Exception> addr2UnsafeSupplier) {

		try {
			addr2 = addr2UnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
	...
	@Schema(
		...
		defaultValue = "com.aixtor.employee.headless.dto.v1_0.Branch",
		name = "x-class-name"
	)
