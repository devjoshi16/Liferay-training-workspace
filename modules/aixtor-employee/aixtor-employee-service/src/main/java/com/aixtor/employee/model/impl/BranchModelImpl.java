...
import com.aixtor.employee.model.BranchModel;
...
/**
 * The base model implementation for the Branch service. Represents a row in the &quot;Employee_Branch&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class BranchModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "Employee_Branch";

	public static final Object[][] TABLE_COLUMNS = {
		{"uuid_", Types.VARCHAR}, {"branchId", Types.BIGINT},
		{"groupId", Types.BIGINT}, {"companyId", Types.BIGINT},
		{"userId", Types.BIGINT}, {"userName", Types.VARCHAR},
		{"createDate", Types.TIMESTAMP}, {"modifiedDate", Types.TIMESTAMP},
		{"name", Types.VARCHAR}, {"countryId", Types.BIGINT},
		{"stateId", Types.BIGINT}, {"cityId", Types.BIGINT}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table Employee_Branch (uuid_ VARCHAR(75) null,branchId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,countryId LONG,stateId LONG,cityId LONG)";

	public static final String TABLE_SQL_DROP = "drop table Employee_Branch";

	public static final String ORDER_BY_JPQL = " ORDER BY branch.name ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Employee_Branch.name ASC";
	...
	static {
		...
		attributeGetterFunctions.put("branchId", Branch::getBranchId);
		attributeSetterBiConsumers.put(
			"branchId", (BiConsumer<Branch, Long>)Branch::setBranchId);
		...
		attributeGetterFunctions.put("countryId", Branch::getCountryId);
		attributeSetterBiConsumers.put(
			"countryId", (BiConsumer<Branch, Long>)Branch::setCountryId);
		attributeGetterFunctions.put("stateId", Branch::getStateId);
		attributeSetterBiConsumers.put(
			"stateId", (BiConsumer<Branch, Long>)Branch::setStateId);
		attributeGetterFunctions.put("cityId", Branch::getCityId);
		attributeSetterBiConsumers.put(
			"cityId", (BiConsumer<Branch, Long>)Branch::setCityId);
	...
	public Object clone() {
		...
		branchImpl.setCountryId(getCountryId());
		branchImpl.setStateId(getStateId());
		branchImpl.setCityId(getCityId());
	...
	public Branch cloneWithOriginalValues() {
		...
		branchImpl.setBranchId(this.<Long>getColumnOriginalValue("branchId"));
		...
		branchImpl.setCountryId(this.<Long>getColumnOriginalValue("countryId"));
		branchImpl.setStateId(this.<Long>getColumnOriginalValue("stateId"));
		branchImpl.setCityId(this.<Long>getColumnOriginalValue("cityId"));
	...
	public CacheModel<Branch> toCacheModel() {
		...
		branchCacheModel.countryId = getCountryId();

		branchCacheModel.stateId = getStateId();

		branchCacheModel.cityId = getCityId();
	...
	static {
		...
		columnBitmasks.put("branchId", 2L);
		...
		columnBitmasks.put("cityId", 2048L);
