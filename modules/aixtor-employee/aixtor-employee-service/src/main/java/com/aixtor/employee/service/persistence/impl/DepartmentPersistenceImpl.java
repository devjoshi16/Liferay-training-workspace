...
import com.aixtor.employee.exception.NoSuchDepartmentException;
import com.aixtor.employee.model.Department;
import com.aixtor.employee.model.DepartmentTable;
import com.aixtor.employee.model.impl.DepartmentImpl;
import com.aixtor.employee.model.impl.DepartmentModelImpl;
import com.aixtor.employee.service.persistence.DepartmentPersistence;
import com.aixtor.employee.service.persistence.DepartmentUtil;
...
public class DepartmentPersistenceImpl
	...
	/**
	 * Returns an ordered range of all the departments where name = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>DepartmentModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns the first department in the ordered set where name = &#63;.
	 *
	 * @param name the name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching department
	...
	/**
	 * Returns the last department in the ordered set where name = &#63;.
	 *
	 * @param name the name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching department
	...
	/**
	 * Returns the departments before and after the current department in the ordered set where name = &#63;.
	 *
	 * @param departmentId the primary key of the current department
	 * @param name the name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	/**
	 * Removes all the departments where name = &#63; from the database.
	 *
	 * @param name the name
	 */
	@Override
