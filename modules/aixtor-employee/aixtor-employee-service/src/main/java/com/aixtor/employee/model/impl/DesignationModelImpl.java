...
import com.aixtor.employee.model.DesignationModel;
...
/**
 * The base model implementation for the Designation service. Represents a row in the &quot;Employee_Designation&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class DesignationModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "Employee_Designation";
	...
	public static final String TABLE_SQL_CREATE =
		"create table Employee_Designation (uuid_ VARCHAR(75) null,designationId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP =
		"drop table Employee_Designation";

	public static final String ORDER_BY_JPQL = " ORDER BY designation.name ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Employee_Designation.name ASC";
	...
	public int compareTo(Designation designation) {
		...
		value = getName().compareTo(designation.getName());
