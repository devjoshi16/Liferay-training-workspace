...
package com.aixtor.employee.service.persistence;
...
public class EmployeeUtil {
	...
	public static Employee findByUuid_First(
		...
		throws com.aixtor.employee.exception.NoSuchEmployeeException {
	 ...
	 * @return the range of matching employees
	 */
	public static List<Employee> findByfirstName(
	 ...
	 * @throws NoSuchEmployeeException if a matching employee could not be found
	 */
	public static Employee findByfirstName_First(
	 ...
	 * @return the first matching employee, or <code>null</code> if a matching employee could not be found
	 */
	public static Employee fetchByfirstName_First(
		String firstName, OrderByComparator<Employee> orderByComparator) {
	 ...
	 * @throws NoSuchEmployeeException if a matching employee could not be found
	 */
	public static Employee findByfirstName_Last(
			String firstName, OrderByComparator<Employee> orderByComparator)
		throws com.aixtor.employee.exception.NoSuchEmployeeException {
	 ...
	 * @return the last matching employee, or <code>null</code> if a matching employee could not be found
	 */
	public static Employee fetchByfirstName_Last(
		String firstName, OrderByComparator<Employee> orderByComparator) {
	 ...
	 * @throws NoSuchEmployeeException if a employee with the primary key could not be found
	 */
	public static Employee[] findByfirstName_PrevAndNext(
			long employeeId, String firstName,
			OrderByComparator<Employee> orderByComparator)
		throws com.aixtor.employee.exception.NoSuchEmployeeException {

		return getPersistence().findByfirstName_PrevAndNext(
			employeeId, firstName, orderByComparator);
	}
