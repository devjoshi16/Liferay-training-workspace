...
/**
 * Provides the local service interface for Auditlogs. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AuditlogsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AuditlogsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.aixtor.employee.logs.service.impl.AuditlogsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the auditlogs local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AuditlogsLocalServiceUtil} if injection and service tracking are not available.
	 */
